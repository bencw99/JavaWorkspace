...
public class Advanced extends SuperLander
{
    ...
    public void drawLander(Graphics screen)
    {
        ...
        int XRot[] = {(int) (xPosDraw + X[0]*Math.cos(angle) - Y[0]*Math.sin(angle)),(int) (xPosDraw + X[1]*Math.cos(angle) - Y[1]*Math.sin(angle)),(int) (xPosDraw + X[2]*Math.cos(angle) - Y[2]*Math.sin(angle)), (int) (xPosDraw + X[3]*Math.cos(angle) - Y[3]*Math.sin(angle)), (int) (xPosDraw + X[4]*Math.cos(angle) - Y[4]*Math.sin(angle))};
        int YRot[] = {(int) (yPosDraw + X[0]*Math.sin(angle) + Y[0]*Math.cos(angle)), (int) (yPosDraw + X[1]*Math.sin(angle) + Y[1]*Math.cos(angle)), (int) (yPosDraw + X[2]*Math.sin(angle) + Y[2]*Math.cos(angle)), (int) (yPosDraw + X[3]*Math.sin(angle) + Y[3]*Math.cos(angle)), (int) (yPosDraw + X[4]*Math.sin(angle) + Y[4]*Math.cos(angle))};
        int Xfin1[] = { - 10, - 12, - 18, - 18};
        int Yfin[] = { + 30, + 12, + 22, + 35};
        int Xfin2[] = { + 10, + 12, + 18, + 18};
        int Xfin2Rot[] = {(int) (xPosDraw + Xfin2[0]*Math.cos(angle) - Yfin[0]*Math.sin(angle)),(int) (xPosDraw + Xfin2[1]*Math.cos(angle) - Yfin[1]*Math.sin(angle)),(int) (xPosDraw + Xfin2[2]*Math.cos(angle) - Yfin[2]*Math.sin(angle)), (int) (xPosDraw + Xfin2[3]*Math.cos(angle) - Yfin[3]*Math.sin(angle))};
        int Xfin1Rot[] = {(int) (xPosDraw + Xfin1[0]*Math.cos(angle) - Yfin[0]*Math.sin(angle)),(int) (xPosDraw + Xfin1[1]*Math.cos(angle) - Yfin[1]*Math.sin(angle)),(int) (xPosDraw + Xfin1[2]*Math.cos(angle) - Yfin[2]*Math.sin(angle)), (int) (xPosDraw + Xfin1[3]*Math.cos(angle) - Yfin[3]*Math.sin(angle))};
        int Yfin1Rot[] = {(int) (yPosDraw + Xfin1[0]*Math.sin(angle) + Yfin[0]*Math.cos(angle)), (int) (yPosDraw + Xfin1[1]*Math.sin(angle) + Yfin[1]*Math.cos(angle)), (int) (yPosDraw + Xfin1[2]*Math.sin(angle) + Yfin[2]*Math.cos(angle)), (int) (yPosDraw + Xfin1[3]*Math.sin(angle) + Yfin[3]*Math.cos(angle))};
        int Yfin2Rot[] = {(int) (yPosDraw + Xfin2[0]*Math.sin(angle) + Yfin[0]*Math.cos(angle)), (int) (yPosDraw + Xfin2[1]*Math.sin(angle) + Yfin[1]*Math.cos(angle)), (int) (yPosDraw + Xfin2[2]*Math.sin(angle) + Yfin[2]*Math.cos(angle)), (int) (yPosDraw + Xfin2[3]*Math.sin(angle) + Yfin[3]*Math.cos(angle))};
